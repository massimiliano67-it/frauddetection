...
class _ChatWidgetState extends State<ChatWidget> {
  ...
  bool _loading = false;
   ...
   final String _prompt =
      ...
      "El dialogo lo debe iniciar tu, te presenta, me saluda (mi nombre es Massimiliano) preguntándome si un reconozco un cargo de (puedes usar un valor entre 1.000.000 y 1.500.000) de pesos en un comercio (puedes inventar el rubro) de hacer 5 minutos  atrás. No ponga la direcccion"
      ...
      "Una vez que contesto a la primera pregunta rechazando o reconociendo el cargo, tu me muestra otros dos cargos (pones nombres de fantasía)."
       "Si yo rechazo uno mas cargos de los tres cargos presentado, tu me anula los cargos rechazados, mantiene los cargos reconocidos y me preguntas si quiero bloquear la tarjeta."
       "Si yo acepto de bloquar la tarjeta sigue con el guion. Si no acepto de bloquear la tarjeta anula los cargos no reconocido y me saluda."
       "Si me bloquea la tarjeta, me dice me enviará la nueva tarjeta en 3 5 días hábiles. Me debe pedir de confirmar la dirección que es El Remanso de Las Condes 11.110, Las Condes"
       "Una vez que confermé la direccion, hace el resumen que bloqueste la tarjeta, debe ser especifico que anula los cargos no reconocidos y mantiene los cargo que reconocido."
       "Si no rechazo nigun cargos, me saluda cordialmente y confirma que mantienes los cargos."
       "Puedes aceptar preguntas para validar los comercios por ejemplo saber la dirección (puedes inventar la direccion)"
